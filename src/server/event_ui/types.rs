...
pub(super) fn payload_pascal_type(payload: &EventPayload) -> &'static str {
    match payload {
        ...
        EventPayload::WorkflowDefinitionCreated { .. } => "WorkflowDefinitionCreated",
        EventPayload::WorkflowDefinitionUpdated { .. } => "WorkflowDefinitionUpdated",
        EventPayload::WorkflowConditionEvaluated { .. } => "WorkflowConditionEvaluated",
        EventPayload::WorkflowWaitActivated { .. } => "WorkflowWaitActivated",
        EventPayload::WorkflowWaitCompleted { .. } => "WorkflowWaitCompleted",
        EventPayload::WorkflowSignalReceived { .. } => "WorkflowSignalReceived",
        EventPayload::WorkflowRunCreated { .. } => "WorkflowRunCreated",
        EventPayload::WorkflowRunStarted { .. } => "WorkflowRunStarted",
        EventPayload::WorkflowRunPaused { .. } => "WorkflowRunPaused",
        EventPayload::WorkflowRunResumed { .. } => "WorkflowRunResumed",
        EventPayload::WorkflowRunCompleted { .. } => "WorkflowRunCompleted",
        EventPayload::WorkflowRunAborted { .. } => "WorkflowRunAborted",
        EventPayload::WorkflowContextInitialized { .. } => "WorkflowContextInitialized",
        EventPayload::WorkflowContextSnapshotCaptured { .. } => "WorkflowContextSnapshotCaptured",
        EventPayload::WorkflowStepInputsResolved { .. } => "WorkflowStepInputsResolved",
        EventPayload::WorkflowOutputAppended { .. } => "WorkflowOutputAppended",
        EventPayload::WorkflowStepStateChanged { .. } => "WorkflowStepStateChanged",
        ...
        EventPayload::WorktreeTurnRefRestored { .. } => "WorktreeTurnRefRestored",
        ...
        EventPayload::RuntimeCommandCompleted { .. } => "RuntimeCommandCompleted",
        EventPayload::RuntimeSessionObserved { .. } => "RuntimeSessionObserved",
        EventPayload::RuntimeTurnCompleted { .. } => "RuntimeTurnCompleted",
