...
- Configure native managed-network and host-approval policy with:
  - `HIVEMIND_NATIVE_NETWORK_PROXY_MODE`
  ...
  - `HIVEMIND_NATIVE_NETWORK_MODE`
  - `HIVEMIND_NATIVE_NETWORK_LIMITED_METHODS`
  - `HIVEMIND_NATIVE_NETWORK_APPROVAL_MODE`
  - `HIVEMIND_NATIVE_NETWORK_APPROVAL_DECISION`
